"""
The algorithm that solves the non-linear integer programming (LIP) P.
"""
import time
import profiling
...
def LIP(jobs, sites):
    ...
    with tqdm(total=total) as pbar:
        pbar.set_description("LIP progress:")
        t = 0
        while True:
            ...
            for job in jobs:
                if job.arrival_time == t:
                    ...
                    _ = common.lip(job=job, solution=solution)
                    e = time.time()
